...
//        view.backgroundColor = #colorLiteral(red: 0.04705037922, green: 0.0470642224, blue: 0.04704734683, alpha: 1)
        view.backgroundColor = Constants.Design.Color.gap
        return view
    }()
...
//        let textWidthAvailable = bounds.width - padding * 3 - thumbnailWidth
        ...
        bottomMargin.frame = CGRect(x: -5.0, y: bounds.maxY - 5.0, width: bounds.width + 10.0, height: 5.0)
    }
...
//        image = image.withTintColor(#colorLiteral(red: 1, green: 1, blue: 1, alpha: 1), renderingMode: .alwaysOriginal)
        actionImage.image = Constants.Design.Image.iconFavorites.withConfiguration(configuration).withTintColor(.white, renderingMode: .alwaysOriginal)
    ...
    func setupViewss() {
        ...
        bottomMargin.bottomAnchor.constraint(equalTo: bottomAnchor).isActive = true
        bottomMargin.centerXAnchor.constraint(equalTo: centerXAnchor).isActive = true
        bottomMargin.widthAnchor.constraint(equalTo: contentView.widthAnchor, constant: 10.0).isActive = true
        bottomMargin.heightAnchor.constraint(equalToConstant: 10.0).isActive = true
        ...
        heading.rightAnchor.constraint(equalTo: contentView.rightAnchor, constant: -10.0).isActive = true
        heading.setContentHuggingPriority(UILayoutPriority.defaultHigh, for: .vertical)
       
        detailText.topAnchor.constraint(equalTo: heading.bottomAnchor, constant: 10.0).isActive = true
        ...
        threadStats.topAnchor.constraint(equalTo: detailText.bottomAnchor, constant: 10.0).isActive = true
        threadStats.leftAnchor.constraint(equalTo: detailText.leftAnchor).isActive = true
        threadStats.rightAnchor.constraint(equalTo: detailText.rightAnchor).isActive = true
        threadStats.bottomAnchor.constraint(lessThanOrEqualTo: contentView.bottomAnchor, constant: -25.0).isActive = true
        ...
        threadThumbnail.leftAnchor.constraint(equalTo: contentView.leftAnchor, constant: 10.0).isActive = true
        threadThumbnail.topAnchor.constraint(equalTo: contentView.topAnchor, constant: 15.0).isActive = true
        threadThumbnail.bottomAnchor.constraint(lessThanOrEqualTo: contentView.bottomAnchor, constant: -25.0).isActive = true
